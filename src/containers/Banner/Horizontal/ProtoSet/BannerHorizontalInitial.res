...
@module("./BannerHorizontalProtoStyle.css.js") external classNameDescription: string = "description"
...
let make = (
  ...
  React.createElementVariadic(
    ...
    ReactDOM.domProps(
      // ~ref = ?nodeRef,
      ~className=Cn.make([classNameRoot, className, BannerHorizontalLayer.resolve(~color, ~size)]),
      ~style=switch style {
    ...
    [
      ...
      P.makeProps(
        ...
        ~className={BannerHorizontalSizeResolver.areas.description ++ " " ++ classNameDescription},
      ...
      React.createElementVariadic(
        ...
        ReactDOM.domProps(
          ...
          ~className=Cn.make([classNameLogo, BannerHorizontalSizeResolver.areas.logo]),
          ~width="267",
          ~height="44",
          ~viewBox="0 0 267 44",
          ~fill="none",
