...
@module("./BannerVerticalProtoStyle.css.js") external classNameDescription: string = "description"
  ...
  React.createElementVariadic(
    ...
    [
      ...
      <P
        ...
        className={BannerVerticalSizeResolver.areas.description ++ " " ++ classNameDescription}>
      ...
      React.createElementVariadic(
        ...
        ReactDOM.domProps(
          ...
          ~className=Cn.make([classNameLogo, BannerVerticalSizeResolver.areas.logo]),
          ~width="267",
          ~height="44",
          ~viewBox="0 0 267 44",
          ~fill="none",
